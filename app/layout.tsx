...
export const metadata: Metadata = {
  ...
  title: {
    default: "FLX Software – Apps. Tools. Klartext.",
    template: "%s | FLX Software",
  },
  description:
    "Software, die arbeitet. Wir bauen Apps und Tools, die Probleme lösen – schnell, stabil, wartbar.",
  keywords: [
    "App-Entwicklung",
    "Web-Entwicklung",
    "Next.js",
  ...
  openGraph: {
    ...
    title: "FLX Software – Apps. Tools. Klartext.",
    description:
      "Software, die arbeitet. Wir bauen Apps und Tools, die Probleme lösen – schnell, stabil, wartbar.",
  },
  twitter: {
